...
const createPzLib = ({ v3d=null, appInstance=null }) => {
    ...
    return {
        ...
        getSceneAnimFrameRate, getSceneByAction, getElements,
    };
};
...
handleAnnot(true, '1', 'Cube', 'this is a cube, bro', 'poi1', undefined);
handleAnnot(true, '>', 'Suzanne', '', 'poi2', undefined);
cubeIsLifted = false;

registerOnClick('Cube', false, false, [0,1,2], false, function(event) {
    if (isObjectVisible('Suzanne')) {
...
eventHTMLElem('click', 'poi2', true, function(event) {
    if (cubeIsLifted == false) {
        operateAnimation('PLAY', 'Cube', 0, 17, 'LoopOnce', 1, function() {}, false);
        cubeIsLifted = true;
    } else {
        operateAnimation('PLAY', 'Cube', 30, 40, 'LoopOnce', 1, function() {}, false);
        cubeIsLifted = false;
    }
});

registerOnHover('Cube', false, function(event) {
    openCloseAnnotation('1', true);
}, function(event) {
    openCloseAnnotation('1', false);
});
