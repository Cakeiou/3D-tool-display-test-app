...
handleAnnot(true, '>', 'Hinge_FrontTopR', '', 'anim1', undefined);
handleAnnot(true, '>', 'Hinge_BackTopR', '', 'anim2', undefined);
handleAnnot(true, '>', 'Vacuum_Chamber', '', 'anim3', undefined);
handleAnnot(true, '1', 'Computer', 'control unit for programming, monitoring, and running the etching processes', 'poi1', undefined);
handleAnnot(true, '2', 'Vacuum_Pump', '<iframe width="560" height="315" src="https://en.wikipedia.org/wiki/Vacuum_pump"></iframe>', 'poi2', undefined);
handleAnnot(true, '3', 'MFC_etc.002', '<iframe width="560" height="315" src="https://en.wikipedia.org/wiki/Mass_flow_controller"></iframe>', 'poi3', undefined);
handleAnnot(true, '4', 'PB_Valve.001', '<iframe width="560" height="315" src="https://en.wikipedia.org/wiki/Diaphragm_valve"></iframe>', 'poi4', undefined);
handleAnnot(true, '5', 'Annotation_Vac', '<iframe width="560" height="315" src="https://en.wikipedia.org/wiki/Vacuum_chamber"></iframe>', 'poi5', undefined);
frontCabOpen = false;
backCabOpen = false;
vacChambOpen = false;
setHTMLElemStyle('display', 'none', 'anim1', false);
setHTMLElemStyle('display', 'none', 'anim2', false);
...
registerOnHover('Door_FrontR', false, function(event) {
    setHTMLElemStyle('display', 'block', 'anim1', false);
}, function(event) {
    setHTMLElemStyle('display', 'none', 'anim1', false);
});
registerOnHover('Door_Back', false, function(event) {
    setHTMLElemStyle('display', 'block', 'anim2', false);
}, function(event) {
    setHTMLElemStyle('display', 'none', 'anim2', false);
});
...
registerOnHover('Computer', false, function(event) {
